...
export function TopBar() {
  return (
    <div className="bg-bg-secondary border-b border-border text-text-secondary text-xs">
      <div className="container-custom">
        <div className="flex items-center justify-between py-2 gap-4 overflow-x-auto no-scrollbar">
          <div className="flex items-center gap-6 whitespace-nowrap">
            <span className="flex items-center gap-1.5">
              ...
              <span>Frete grátis acima de <strong className="text-accent-gold">R$199</strong></span>
            </span>
            <span className="hidden sm:flex items-center gap-1.5">
              <svg className="w-3.5 h-3.5 text-accent-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z" />
              </svg>
              <span>Até <strong className="text-accent-gold">6x sem juros</strong></span>
            </span>
          </div>
          <div className="flex items-center gap-6 whitespace-nowrap">
